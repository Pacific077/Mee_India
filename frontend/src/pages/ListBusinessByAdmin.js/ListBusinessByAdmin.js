...
const ListBusinessByAdmin = () => {
  ...
  const handleSubmit = async()=>{
    ...
    formData.bussinessContact===""||formData.bussinessAltContact===""||
    formData.bussinessMail===''||formData.bio===''||mainCategory===""||subCategory==="")toast.warning("All Fields are necessary")
    if(imagelinkArr.length<3)toast.warning("Select atleast 3 images.")
  ...
  return (
    ...
    <div>
      ...
      {subCatArr.length !== 0 && (
        <div>
          <label className="formLabel">Select all suitable Sub-Categories for the business:</label>
