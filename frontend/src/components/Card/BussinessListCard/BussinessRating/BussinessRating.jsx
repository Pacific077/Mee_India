...
if(starAverage < 5) {
  ...
  return (
    <div className='RatingContainer'>
        <div className='RatingPoint'><span>{parseFloat((ratingCnt/ratersCnt).toFixed(1))}</span></div> 
        <div className='RatingStars'>{starArr.map((val, i) => {
            return <div key={i} 
                className="starBox"
                style={{background: `linear-gradient(90deg, #e76901 
